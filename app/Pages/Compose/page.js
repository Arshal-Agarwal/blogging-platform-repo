...
export default function Compose() {
    return (
        <div className=" min-w-64 pl-24">
            <label htmlFor=""></label>
            <input className="title w-3/4 p-2  border border-gray-300 rounded mt-10" type="text" value="" placeholder='Input Title here' />

            <div className='pr-16 mt-8'>
                <label for="Description" className="block text-sm text-gray-500 dark:text-gray-300">Blog Content:</label>

                <textarea placeholder="Blog Content" className="block  mt-2  w-full  placeholder-gray-400/70 dark:placeholder-gray-800 rounded-lg border border-gray-200 bg-white px-4 h-96 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600  dark:text-gray-300 dark:focus:border-blue-300"></textarea>
            </div>

            <button className="mt-6  px-6 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                Submit
            </button>
