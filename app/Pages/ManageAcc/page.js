                ...
                <aside className="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <div className="flex flex-col justify-between flex-1 mt-6">
                        <nav>
                            ...
                            <Link className="flex items-center px-4 py-2 mt-5 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200" href="../Pages/ManageAcc">
                                <span className="mx-4 font-medium">Manage Account</span>
                            </Link>

                            <Link className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800" href="/">
